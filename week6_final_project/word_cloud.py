...
def calculate_frequencies(file_contents):
    ...
    for letter in punctuations:
        punctuations_set.add(letter)
        uninteresting_words_set = set()
    for word in uninteresting_words:
        uninteresting_words_set.add(word.lower())
    new_file_contents = ""
    for letter in file_contents:
        if letter not in punctuations_set:
            new_file_contents += letter.lower()
    frequencies = {}
    words = new_file_contents.split()
    for word in words:
        if word.lower() not in uninteresting_words_set:
